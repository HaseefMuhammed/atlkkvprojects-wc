const apiKey = 'AIzaSyAq5WuPkSfwfEHFmvzG1o8o0Om1r3C50wU'; // Replace with your actual API key
...
recognition.onresult = (event) => {
  ...
  if (normalizedTranscript.includes('sir')) { // Change 'Ustad' to 'ustad'
      const question = normalizedTranscript.replace(/sir/i, '').trim(); // Change 'Ustad' to 'ustad'
      if (question) {
